...
@with_kw struct NumericalParameters
	...
	grid_y::Array{Float64,1} 	 = exp.(Tauchen(m_par.ρ_h, ny)[1] .* m_par.σ_h ./ sqrt(1.0 .- m_par.ρ_h.^2))  # income grid
...
@with_kw struct EstimationSettings
    ...
    meas_error_distr::Array{InverseGamma{Float64},1} = [ InverseGamma(ig_pars(0.0005, 0.001^2)...), InverseGamma(ig_pars(0.0005, 0.001^2)...), InverseGamma(ig_pars(0.0005, 0.001^2)...)]

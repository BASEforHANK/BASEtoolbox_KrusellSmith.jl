...
function prepare_linearization(KSS, VmSS, distrSS, n_par, m_par)
    ...
    KSS, TransitionMatSS, c_n_starSS, m_n_starSS, VmSS, distrSS =Ksupply(rSS, n_par, m_par, VmSS, inc)

    VmSS        = log.(invmutil.(VmSS))
    
    # Produce distributional summary statistics
    distr_m_SS, distr_y_SS, TOP10WshareSS, TOP10IshareSS, GiniWSS, GiniXSS, GiniCSS, GiniISS, sdlogySS = 
